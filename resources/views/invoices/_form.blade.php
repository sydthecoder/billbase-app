...
<div
    x-data="invoiceForm({{ $products->toJson() }}, {{ json_encode($initialItems) }})"
...
>
    ...
    <div class="bg-white rounded-2xl border border-[#e5e7eb] shadow-md p-6 md:p-8 flex flex-col gap-6">
        <div>
            <h3 class="text-[20px] font-bold tracking-tight text-[#030712] mb-1">Invoice Details</h3>
            <p class="text-[14px] text-[#6b7280]">Who this invoice is for and when it's due.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="flex flex-col gap-2">
                <label class="text-[14px] font-medium text-[#030712]" for="due_date">Due Date <span class="text-[#dc2626]">*</span></label>
                <input
                    type="date"
                    id="due_date"
                    name="due_date"
    ...
    <div class="bg-white rounded-2xl border border-[#e5e7eb] shadow-md p-6 md:p-8 flex flex-col gap-6">
        <div>
            ...
            <p class="text-[14px] text-[#6b7280]">Extra text shown on the invoice PDF.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="flex flex-col gap-2">
                ...
                <textarea
                    ...
                    class="w-full bg-white border border-[#d1d5db] rounded-xl px-4 py-3 text-[16px] text-[#030712] focus:outline-none focus:border-primary-500 focus:ring-[1px] focus:ring-primary-500 transition-all"
                >{{ old('footer', $invoice->footer ?? '') }}</textarea>
            </div>
        </div>
    </div>
...
@push('scripts')
<script>
function invoiceForm(products, initialItems) {
    return {
        products:        products,
        items:           initialItems,
