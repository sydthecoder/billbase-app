                        ...
                        @forelse ($customers as $customer)
                            <tr>
                                <td class="border border-gray-300 px-4 py-2">
                                    <a href="{{ route('customers.show', $customer->id) }}" class="underline">
                                ...
                                <td class="border border-gray-300 px-4 py-2">{{ ucfirst($customer->status) }}</td>
                                <td class="border border-gray-300 px-4 py-2">
                                    <div class="inline-flex gap-2 items-center rounded-md shadow-sm">
                                        ...
                                        <form method="POST" action="{{ route('customers.destroy', $customer->id) }}"
                                              onsubmit="return confirm('Delete customer {{ $customer->customer_code }}?')" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
