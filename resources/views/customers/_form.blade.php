...
<div class="flex flex-col gap-8">
    ...
    <div class="bg-white rounded-2xl border border-[#e5e7eb] shadow-md p-6 md:p-8 flex flex-col gap-6">
        <div>
            <h3 class="text-[20px] font-bold tracking-tight text-[#030712] mb-1">Company Details</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="flex flex-col gap-2 md:col-span-2">
                <label class="text-[14px] font-medium text-[#030712]" for="company_name">Company Name</label>
                <input
                    type="text"
                    id="company_name"
                    name="company_name"
            ...
            <div class="flex flex-col gap-2">
                <label class="text-[14px] font-medium text-[#030712]" for="company_reg_number">Company Reg Number</label>
                <input
                    type="text"
            ...
            <div class="flex flex-col gap-2">
                <label class="text-[14px] font-medium text-[#030712]" for="vat_number">VAT Number</label>
                <input
                    type="text"
                    id="vat_number"
                    name="vat_number"
    ...
    <div class="bg-white rounded-2xl border border-[#e5e7eb] shadow-md p-6 md:p-8 flex flex-col gap-6">
        <div>
            <h3 class="text-[20px] font-bold tracking-tight text-[#030712] mb-1">Contact Person</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="flex flex-col gap-2">
                <label class="text-[14px] font-medium text-[#030712]" for="first_name">First Name <span class="text-[#dc2626]">*</span></label>
                <input
                    type="text"
                    id="first_name"
                    name="first_name"
            ...
            <div class="flex flex-col gap-2">
                <label class="text-[14px] font-medium text-[#030712]" for="last_name">Last Name <span class="text-[#dc2626]">*</span></label>
                <input
                    type="text"
                    id="last_name"
                    name="last_name"
            ...
            <div class="flex flex-col gap-2">
                <label class="text-[14px] font-medium text-[#030712]" for="email">Email <span class="text-[#dc2626]">*</span></label>
                <input
                    type="email"
                    id="email"
                    name="email"
            ...
            <div class="flex flex-col gap-2">
                <label class="text-[14px] font-medium text-[#030712]" for="phone">Phone</label>
                <input
                    type="text"
                    id="phone"
                    name="phone"
    ...
    <div class="bg-white rounded-2xl border border-[#e5e7eb] shadow-md p-6 md:p-8 flex flex-col gap-6">
        <div>
            <h3 class="text-[20px] font-bold tracking-tight text-[#030712] mb-1">Address</h3>
        ...
        <div class="flex flex-col gap-6">
            <div class="flex flex-col gap-2">
                <label class="text-[14px] font-medium text-[#030712]" for="street_address">Street Address</label>
                <input
                    type="text"
                    id="street_address"
                    name="street_address"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="flex flex-col gap-2">
                    <label class="text-[14px] font-medium text-[#030712]" for="suburb">Suburb</label>
                    <input
                        type="text"
                        id="suburb"
                        name="suburb"
                ...
                <div class="flex flex-col gap-2">
                    <label class="text-[14px] font-medium text-[#030712]" for="city">City</label>
                    <input
                        type="text"
                        id="city"
                        name="city"
                ...
                <div class="flex flex-col gap-2">
                    <label class="text-[14px] font-medium text-[#030712]" for="province">Province</label>
                    <div class="relative">
                        <select
                            id="province"
                            name="province"
                ...
                <div class="flex flex-col gap-2">
                    <label class="text-[14px] font-medium text-[#030712]" for="postal_code">Postal Code</label>
                    <input
                        type="text"
                        id="postal_code"
                        name="postal_code"
    ...
    <div class="bg-white rounded-2xl border border-[#e5e7eb] shadow-md p-6 md:p-8 flex flex-col gap-6">
        <div>
            <h3 class="text-[20px] font-bold tracking-tight text-[#030712] mb-1">Notes & Status</h3>
