<x-layouts.auth title="Login">
    <div class="h-screen items-center justify-center flex">
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <img src="{{ asset('logo.png') }}" alt="" class="h-12 mx-auto mb-12">

            <div class="relative bg-white py-8 px-6 rounded-lg shadow">
                <div>
                    <div class="text-center">
                        <h2 class="mb-8 text-3xl font-semibold leading-5 text-dark">
                            Login
                        </h2>         
                    </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                type="email" 
                                value="{{ old('email') }}" 
                                class="block w-full rounded-md border border-gray-300 px-4 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-dark focus:ring-offset-1"
                        ...
                        <div>
                            ...
                            <input 
                                name="password" 
                                type="password" 
                                class="mt-2 block w-full rounded-md border border-gray-300 px-4 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-dark focus:ring-offset-1"
                        ...
                        <button 
                            type="submit"
                            :disabled="loading"
                            class="cursor-pointer inline-flex w-full items-center justify-center gap-2 rounded-lg bg-dark p-2 py-3 text-[15px] font-medium text-white outline-none focus:ring-2 focus:ring-dark focus:ring-offset-1 disabled:bg-gray-400"
                        >
                    ...
                    <div class="mt-6 text-center text-[14px] text-gray-600">
                        ...
                        <a href="{{ route('register') }}" class="border-b border-dashed border-gray-400">Register</a>
                    </div>
                </div>
            </div>
        </div>
