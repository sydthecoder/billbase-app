...
<aside class="hidden md:flex md:flex-col md:w-65 bg-white fixed top-0 left-0 h-full border-r border-[#e5e7eb]">
    ...
    <nav class="flex-1 overflow-y-auto p-6 flex flex-col gap-2">
        <a 
            href="#" 
            class="flex items-center gap-3 px-3 py-2.5 rounded-3 text-[16px] font-medium text-[#4b5563] hover:bg-[#f9fafb] hover:text-[#030712] transition-colors"
        >
        ...
        <a 
            ...
            class="flex items-center gap-3 px-3 py-2.5 rounded-3 text-[16px] font-medium transition-colors {{ request()->routeIs('invoices.*') ? 'text-[#030712] bg-[#f2f2ff]' : 'text-[#4b5563] hover:bg-[#f9fafb] hover:text-[#030712]' }}"
        >
        ...
        <a 
            ...
            class="flex items-center gap-3 px-3 py-2.5 rounded-3 text-[16px] font-medium transition-colors {{ request()->routeIs('quotess.*') ? 'text-[#030712] bg-[#f2f2ff]' : 'text-[#4b5563] hover:bg-[#f9fafb] hover:text-[#030712]' }}"
        >
        ...
        <div class="flex flex-col gap-1" x-data="{ open: {{ request()->routeIs('settings.*') ? 'true' : 'false' }} }">
            <button 
                ...
                class="w-full flex items-center justify-between px-3 py-3 rounded-3 text-[16px] font-semibold text-[#4b5563] transition-colors"
            >
