...
<aside class="hidden md:flex md:flex-col md:w-65 bg-white fixed top-0 left-0 h-full border-r border-[#e5e7eb]">
    ...
    <nav class="flex-1 overflow-y-auto p-6 flex flex-col gap-2">
        <a 
            ...
            class="flex items-center gap-3 px-3 py-2.5 rounded-md font-medium transition-colors {{ request()->routeIs('dashboard*') ? 'text-[#030712] bg-[#f2f2ff]' : 'text-[#4b5563] hover:bg-[#f9fafb] hover:text-[#030712]' }}"
        >
            ...
            <div x-show="open" x-transition class="flex flex-col gap-1 pl-9 pr-2">
                @foreach ($invoicesLinks as $link)
                    <a href="{{ route($link['route']) }}"
                       class="block px-3 py-2 rounded-md text-[14px] transition-colors {{ request()->routeIs($link['active']) ? 'font-semibold text-[#008374] bg-[#f2f2ff]' : 'font-medium text-[#4b5563] hover:text-[#030712] hover:bg-[#f9fafb]' }}">
                        {{ $link['label'] }}
                    </a>
                @endforeach
            </div>
        ...
        <a 
            ...
            class="flex items-center gap-3 px-3 py-2.5 rounded-md font-medium transition-colors {{ request()->routeIs('quotess.*') ? 'text-[#030712] bg-[#f2f2ff]' : 'text-[#4b5563] hover:bg-[#f9fafb] hover:text-[#030712]' }}"
        >
        ...
        <a 
            ...
            class="flex items-center gap-3 px-3 py-2.5 rounded-md font-medium transition-colors {{ request()->routeIs('customers.*') ? 'text-[#030712] bg-[#f2f2ff]' : 'text-[#4b5563] hover:bg-[#f9fafb] hover:text-[#030712]' }}"
        >
    ...
    <div class="mt-auto p-4 border-t border-[#e5e7eb]">
        <div class="bg-[#f2f2ff] border border-[#008374]/20 rounded-lg flex items-center gap-3 p-2 rounded-3 hover:bg-[#f9fafb] cursor-pointer transition-colors">
            <div class="w-10 h-10 rounded-[50px] bg-[#f2f2ff] border border-[#008374] flex items-center justify-center text-[#008374] font-semibold text-[14px]">
